            ...
            if (InterestController == null)
            {
                ...
                if (InterestController == null)
                {
                    ...
                    if (InterestController == null)
                    {
                        ...
                        InterestController = transform.parent.parent.parent.gameObject.GetComponent<VRR_Interest_Controller>();

                        if (InterestController == null)
                        {
                            if (ShowDebugLog) { Debug.Log("Frustum: interest Controller Not Set, searching Grand Parent Object for component"); }

                            InterestController = transform.parent.parent.parent.parent.gameObject.GetComponent<VRR_Interest_Controller>();

                            if (InterestController == null)
                            {
                                if (ShowDebugLog) { Debug.Log("Frustum: interest Controller Not Set, searching Grand Parent Object for component"); }

                                InterestController = transform.parent.parent.parent.parent.parent.gameObject.GetComponent<VRR_Interest_Controller>();

                                if (InterestController == null)
                                {
                                    if (ShowDebugLog) { Debug.Log("Frustum: interest Controller Not Set, searching Grand Parent Object for component"); }

                                    InterestController = transform.parent.parent.parent.parent.parent.parent.gameObject.GetComponent<VRR_Interest_Controller>();

                                    if (InterestController == null)
                                    {
                                        if (ShowDebugLog) { Debug.Log("Frustum: interest Controller Not Set, searching Grand Parent Object for component"); }

                                        InterestController = transform.parent.parent.parent.parent.parent.parent.parent.gameObject.GetComponent<VRR_Interest_Controller>();

                                        if (InterestController == null)
                                        {
                                            if (ShowDebugLog) { Debug.Log("Frustum: interest Controller Not Set, searching Grand Parent Object for component"); }

                                            InterestController = transform.parent.parent.parent.parent.parent.parent.parent.parent.parent.gameObject.GetComponent<VRR_Interest_Controller>();

                                            if (InterestController == null)
                                            {
                                                if (ShowDebugLog) { Debug.Log("Frustum: interest Controller Not Set, searching Grand Parent Object for component"); }

                                                InterestController = transform.parent.parent.parent.parent.parent.parent.parent.parent.parent.parent.gameObject.GetComponent<VRR_Interest_Controller>();
